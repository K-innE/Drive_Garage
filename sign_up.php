...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($select_users) > 0) {
        ...
        } else if (!preg_match("/[a-z]/i", $password) || !preg_match("/[0-9]/i", $password)) {
            $message[] = 'Invalid password! Password must contain at least one letter and one number.';
        } else {
            // Hash the password
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="" name="sign_up" method="post" novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <label for="CheckyourPassword" class="form-label">Check Password</label>
                      <input type="password" name="check_password" class="form-control" id="yourPassword" required>
                      <div class="invalid-feedback">Please enter your password!</div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Already have an account? <a href="log_in.php">Log in</a></p>
                    </div>
                  </form>
