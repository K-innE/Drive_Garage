        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="<?php echo $_SESSION['photo']; ?>" alt="" class="rounded-circle">
              <h2><?php echo $_SESSION['name']." ".$_SESSION['last_name'] ; ?></h2>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $_SESSION['name']." ".$_SESSION['last_name'] ; ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Company</div>
                    <div class="col-lg-9 col-md-8">Jeel DZ</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $_SESSION['adress'] ; ?></div>
                  </div>
